...
const wienspaziergang = L.featureGroup()
let myLayers = {
...
let myMapControl = L.control.layers({ //http://leafletjs.com/reference-1.3.0.html#control-layers
    ...
    "Wetterstationen" : wienspaziergang
...
async function addGeojson(url) {
    ...
    wienspaziergang.addLayer(geojson);
    myMap.fitBounds(wienspaziergang.getBounds());
...
myMap.addLayer(wienspaziergang)
