...
for (let i=0; i<awsdata.length ; i++) {
	einzelneStation = awsdata[i];
	L.marker([einzelneStation.lat,einzelneStation.lng], markerOptions).addTo(markerGroup).bindPopup("<strong>" + einzelneStation.name +"</strong></br>Temperatur: " + einzelneStation.temperatur + "</br> Aufnahmedatum: " + einzelneStation.datum + "</br><a href="+einzelneStation.link +">Link zur aktuellen Grafik").openPopup();
}
